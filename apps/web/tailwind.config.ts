  ...
  theme: {
    ...
    extend: {
      ...
      animation: {
        ...
        'slide-up': 'slideUp 260ms cubic-bezier(0.34, 1.56, 0.64, 1)',
        ...
        'modal-in': 'modalIn 260ms cubic-bezier(0.16, 1, 0.3, 1)',
        'modal-out': 'modalOut 180ms cubic-bezier(0.4, 0, 1, 1)',
        'overlay-in': 'overlayIn 200ms cubic-bezier(0.4, 0, 0.2, 1)',
        'segment-slide': 'segmentSlide 260ms cubic-bezier(0.34, 1.56, 0.64, 1)',
      },
      keyframes: {
        fadeIn: {
