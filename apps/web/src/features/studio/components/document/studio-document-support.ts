...
import { invalidateChapterQueries } from "@/features/studio/components/document/chapter-editor-support";
import { invalidateStoryAssetQueries } from "@/features/studio/components/document/story-asset-editor-support";
import {
  buildStudioDocumentCatalogQueryKey,
  buildStudioDocumentCatalogVersion,
} from "@/features/studio/components/document/studio-document-catalog-support";
