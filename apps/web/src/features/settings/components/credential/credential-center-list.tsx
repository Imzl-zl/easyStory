      ...
      <div className="space-y-4">
        <div className="flex flex-wrap items-start justify-between gap-3.5">
          <div className="space-y-1">
            ...
            <p className="text-sm leading-6 text-text-secondary">查看、验证连接与工具兼容性，并管理已有连接。</p>
          </div>
            ...
            >
              <div className="space-y-2.5">
                <div className="flex flex-wrap items-center gap-2">
                  ...
                  {overrideInfo ? (
                    <span
                      className="rounded-full border border-line-strong bg-surface-hover px-3 py-1 text-xs text-accent-primary"
                ...
                <p className="text-sm text-text-secondary">{formatCredentialTokenSummary(credential)}</p>
                <p className="text-sm text-text-secondary">
                ...
                {overrideInfo ? (
                  <p className="text-xs leading-5 text-accent-primary">
