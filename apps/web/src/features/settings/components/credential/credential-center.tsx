...
import { CredentialCenterContent } from "@/features/settings/components/credential/credential-center-content";
import {
  ...
  const actionMutation = useMutation({
    mutationFn: async ({
      ...
      if (type === "verify_buffered_connection") {
        return verifyCredential(credentialId, "text_probe", "buffered");
      }
