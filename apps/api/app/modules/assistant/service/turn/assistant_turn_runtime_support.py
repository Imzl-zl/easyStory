...
if TYPE_CHECKING:
    ...
    from ..tooling.assistant_tool_runtime_dto import AssistantToolDescriptor, AssistantToolPolicyDecision
...
def build_turn_continuation_anchor_snapshot(
    ...
    if anchor is None:
        return None
    return {
        "previous_run_id": str(anchor.previous_run_id),
        "messages_digest": (
            anchor.messages_digest
            or build_turn_messages_digest(payload.messages[:-1])
        ),
    }
