...
def build_assistant_hook_payload(
    *,
    ...
    document_context_bindings_snapshot: list[dict[str, Any]] | None,
    ...
    exposed_tool_names_snapshot: list[str],
    ...
    payload: dict[str, Any] = {
        ...
        "request": {
            ...
            "document_context_bindings_snapshot": document_context_bindings_snapshot,
            ...
            "exposed_tool_names_snapshot": list(exposed_tool_names_snapshot),
            "requested_write_scope": requested_write_scope,
            "requested_write_targets": list(requested_write_targets),
